// lib
const { forgotPasswordPageContentSecurityPolicy } = require('../../../../src/middleware/content-security-policy/sections/forgot-password')

describe('forgotPasswordPageContentSecurityPolicy()', () => {
